<template>
  <svg viewBox="0 0 1024 1024" class="icon fill-primary" xmlns="http://www.w3.org/2000/svg">
    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
    <g id="SVGRepo_iconCarrier">
      <path class="fill-primary" d="M288 896h448q32 0 32 32t-32 32H288q-32 0-32-32t32-32z"></path>
      <path
        class="fill-primary"
